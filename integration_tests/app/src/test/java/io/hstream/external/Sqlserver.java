...
public class Sqlserver extends Jdbc {
    ...
    public Sqlserver() {
        service = new GenericContainer<>("mcr.microsoft.com/mssql/server:2022-latest")
    ...
    public void enableCdcForTable(String table) {
        var sql = String.format(
                "EXEC sys.sp_cdc_enable_table @source_schema = 'dbo', @source_name = '%s', @role_name = NULL, @supports_net_changes = 0;", table);
        execute(sql);
    }
